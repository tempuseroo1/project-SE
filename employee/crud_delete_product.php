...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            header('Location: crud_read_product.php');
            exit;
        }
    }
} else {
...
<div class="content delete">
    ...
    <div class="yesno">
        <a href="crud_delete_product.php?id=<?=$product['id']?>&confirm=yes">Yes</a>
        <a href="crud_delete_product.php?id=<?=$product['id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
